...
export async function getWidgetData(widgetId: number): Promise<WidgetData | null> {
  try {
...
export async function updateWidget(widgetId: number, data: any): Promise<boolean> {
  try {
